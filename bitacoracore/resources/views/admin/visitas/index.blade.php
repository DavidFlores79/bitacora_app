          ...
          <tbody>
            <tr dir-paginate="dato in datosFiltrados = (datos|filter:servicios.servicio_id|orderBy:sortType:sortReverse)|itemsPerPage:pageSize" current-page="currentPage" pagination-id="itemsPagination">
              ...
              <td class="d-flex justify-content-between">
                ...
                <button class="btn btn-danger" ng-click="eliminar(dato.id)"><span data-toggle="tooltip" data-placement="top" title="Eliminar dato" onmouseenter="$(this).tooltip('show')"><i class="fas fa-trash-alt"></i></button>
