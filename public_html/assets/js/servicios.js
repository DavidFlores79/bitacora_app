var app = angular.module('servicios', [ 'angularUtils.directives.dirPagination' ]);

app.controller( 'servicios', function ($scope, $http, $httpParamSerializerJQLike) {
  $scope.currentPage = 1;
  $scope.pageSize = 11;
